...
//Elementleri okumak için tanımlama
...
// sepete ne kadar eklendğini bulmak için for döngüsü
for(let i = 0; i < addToCartButtons.length; i++){
    addToCartButtons[i].addEventListener('click', addToCart)
    
}
// Sepete ürün ekleme yeri
function addToCart(event){
    ...
    <td><button class="uk-button uk-button-danger" type="button">Sil</button></td>
`
...
// Burda toplam fiyat ve ürünler bulunuyor
